...
`;
  ...
  async getVolume(
    ...
    try {
      ...
      const programOwnershipOld = await this.finishedEntity
        .createQueryBuilder('finished')
        .select(['pro.customer_id'])
      ...
      const programOwnershipNew = await this.finishedEntity
        .createQueryBuilder('finished')
        .select(['pro.customer_id'])
      ...
      const finishedTrainingsOld = await this.finishedEntity
        .createQueryBuilder('finished')
        .select([
          'finished.execution_day',
          'finished.distance_in_meters',
      ...
      const finishedTrainingsNew = await this.finishedEntity
        .createQueryBuilder('finished')
        .select([
          'finished.execution_day',
          'finished.distance_in_meters',
